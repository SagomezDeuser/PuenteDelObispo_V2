//-----------------CLASES ESENCIALES----------------------
class lib_accionamiento_motor_d
{
  ...
  public lib_accionamiento_motor_d(string instancia, string tipo){
  ...
  public void set_inhabilitado(bool inhabilitado){
    dpSet(get_inhabilitado(), 1);  //Poner Xd_INHA en modo inhabilitado
  }
  ...
  public void set_tiempo_cp_f2(int tiempo){
    dpSet(get_tiempo_cp_f2(), tiempo);
  }

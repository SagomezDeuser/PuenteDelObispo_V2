//-----------------CLASES ESENCIALES----------------------
class lib_accionamiento_motor_d_var
{
  ...
  //InOut
  private static string xd_m_om_f1 = "InOut.Xd_M_OM_F1"; //Modo Funcionamiento 1 - Avance
  private static string xd_m_om_f2 = "InOut.Xd_M_OM_F2"; //Modo Funcionamiento 2 - Retroceso
  ...
  public lib_accionamiento_motor_d_var(string instancia, string tipo){
  ...
  public void set_tiempo_cm_f2(int tiempo){
    dpSet(get_tiempo_cm_f2(), tiempo);
  }
  ...
  public dyn_anytype rellenar_array_address(){
    ...
    variable_estado_address = makeDynAnytype(makeDynAnytype(xd_inha, FALSE), makeDynAnytype(xi_modo, TRUE), makeDynAnytype(xr_dato_1, TRUE),
                                             ...
                                             makeDynAnytype(yd_alarma_cm_f1, TRUE), makeDynAnytype(yd_alarma_cp_f1, TRUE), makeDynAnytype(yd_alarma_cm_f2, TRUE), makeDynAnytype(yd_alarma_cp_f2, TRUE),
                                             makeDynAnytype(xd_reset_parcial, FALSE), makeDynAnytype(xd_reset_total, FALSE),
                                             ...
                                             makeDynAnytype(archivado_bbdd, FALSE),makeDynAnytype(yd_alarma_ext, TRUE),makeDynAnytype(xd_habilitar, FALSE),
                                             makeDynAnytype(xt_tiempovigilancia_cm_f2, FALSE),makeDynAnytype(xt_tiempovigilancia_cp_f2, FALSE));
  ...
  public dyn_anytype rellenar_unidades_dp(){
    ...
    variable_unidad_dp = makeDynAnytype(makeDynAnytype(xd_inha, ""), makeDynAnytype(xi_modo, ""), makeDynAnytype(xr_dato_1, "Hz"),
                                        makeDynAnytype(xr_dato_2, "rpm"), makeDynAnytype(xr_dato_3, "A"),
                                        makeDynAnytype(yb_est, ""), makeDynAnytype(yr_csg, ""),
                                        makeDynAnytype(xd_m_om_f1, ""), makeDynAnytype(xd_m_om_f2, ""), makeDynAnytype(xr_a_csg, "rpm"), makeDynAnytype(xr_m_csg, "rpm"),
                                        ...
                                        makeDynAnytype(yd_alarma_cm_f1, ""), makeDynAnytype(yd_alarma_cp_f1, ""), makeDynAnytype(yd_alarma_cm_f2, ""), makeDynAnytype(yd_alarma_cp_f2, ""),
                                        makeDynAnytype(xd_reset_parcial, ""), makeDynAnytype(xd_reset_total, ""),
                                        ...
                                        makeDynAnytype(archivado_bbdd, ""),makeDynAnytype(yd_alarma_ext, ""),makeDynAnytype(xd_habilitar, ""),
                                        makeDynAnytype(xt_tiempovigilancia_cm_f2, "s"),makeDynAnytype(xt_tiempovigilancia_cp_f2, "s"));
